...
\setotherlanguages{french,russian,greek,german,latin,polish,italian,dutch,bulgarian, vietnamese}
...
\huge\centering {\itshape sampler and feature list} \\[1cm]
\normalsize\centering {for version 0.004} \\
\hrulefill
\end{titlepage}
\cleardoublepage
...
\section*{Vietnamese, 12pt Medium}

\textvietnamese{\addfontfeature{Weight=500}\vnum{1}Vào thời ấy, Hoàng Đế 
Âu-gút-tơ ra chiếu chỉ kiểm tra dân số khắp
 đế quốc La Mã. Nt: thế giới có người ở\vnum{2} Đây là cuộc kiểm tra đầu 
 tiên được thực hiện khi Qui-ri-ni-u làm thống đốc Sy-ri.\vnum{3} Mọi người 
 đều phải về quê quán đăng ký.\vnum{4} Vì Giô-sép thuộc giòng họ nhà Đa-vít 
 nên cũng từ thành Na-xa-rét, thuộc vùng Ga-li-lê xuống Giu-đê, đến 
 Bết-lê-hem, thành của Đa-vít,\vnum{5} để đăng ký cho mình và cho Ma-ri, người 
 đã đính hôn với mình, đang có thai.\vnum{6} Trong khi ở đó Ma-ri chuyển bụng 
 sinh nở.\vnum{7} Nàng sinh con trai đầu lòng, lấy khăn bọc hài nhi đặt nằm 
 trong máng cỏ, vì quán trọ không còn chỗ.\vnum{8} Trong vùng đó, có mấy người 
 chăn chiên ở ngoài đồng, thức đêm canh bầy chiên.\vnum{9} Một thiên sứ của 
 Chúa hiện đến, hào quang Chúa tỏa sáng chung quanh nên họ rất khiếp 
 sợ.\vnum{10} Thiên sứ bảo: “Đừng sợ! Vì này tôi báo cho các anh một Tin 
 Mừng, Ctd: Phúc Âm một niềm vui lớn cũng là Tin Mừng cho mọi 
 người.\vnum{11} Hôm nay, tại thành Đa-vít, một Đấng Cứu Thế vừa giáng sinh 
 cho các anh. Ngài là Chúa Cứu Thế, Nguyên tác Hy Lạp “Xristos” 
 là Chúa.\vnum{12} Đây là dấu hiệu cho các anh nhận ra Ngài: Các anh sẽ gặp 
 một hài nhi bọc trong khăn đặt nằm trong máng cỏ.”}
...
variable version of Noto Sans and you find the Regular weight (400) a little too light to fit
with your design, but the 
...
which varies the shapes of characters with the type size: small type is proportionally wider than 
...
pp. 12–13: Luke 1:1–12 in Vietnamese.

pp. 13: Mark 1:1–10 in Dutch.

p. 14: Genesis 1:1–10 in Bulgarian.

pp. 14: Arnauld de Oihenart (1592–1668), \textit{Uskarazco Zuhur-Hitzac}
...
\hrulefill
\begin{center}\normalsize
This document was set in IrradiantV and composed with LuaLaTeX.\\
The font and this document copyright © 2025 by Peter S. Baker.\\
Irradiant is available under the Open Font License.\\
To get it, visit\\
https:\slash\slash github.com\slash psb1558\slash Irradiant-font
\end{center}
\end{document}
